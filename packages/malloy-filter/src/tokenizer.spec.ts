...
function makeParams(): TokenizerParams {
    ...
    return { splitOnWhitespace: true, trimWordWhitespace: true, specialSubstrings, specialWords };
}

describe('Tokenizer', () => {
    const makeToken = (type: string, value: string, startIndex: number, endIndex: number): Token => ({ type, value, startIndex, endIndex });
    it('should tokenize a simple string', () => {
        const input = 'hello world';
        const expectedTokens = [makeToken('word', 'hello', 0, 5), makeToken('word', 'world', 6, 11)];
    ...
    it('should split adjacent characters when no whitespace', () => {
        ...
        expect(new Tokenizer(input, { ...makeParams(), specialSubstrings}).parse()).toEqual(expectedTokens);
    });
    it('should match special tokens', () => {
        ...
        expect(
            new Tokenizer(input, params).parse(),
    ...
    describe('mergeTypes', () => {
        ...
        it('should not merge tokens when no match is found', () => {
            const tokens: Token[] = [{ type: 'x', value: '1', startIndex:0, endIndex: 1 },
        ...
        it('should merge tokens when a single match is found', () => {
            const tokens: Token[] = [{ type: 'a', value: '1', startIndex:0, endIndex: 1 },
        ...
        it('should not merge partial matches', () => {
            const tokens: Token[] = [{ type: 'a', value: '1', startIndex:0, endIndex: 1 }, { type: 'b', value: '2', startIndex:1, endIndex: 2 }];
    ...
    describe('matchTypes', () => {
        ...
        it('should return all matching tokens when multiple types match', () => {
          const tokens = [makeToken('a', '1', 0, 1), makeToken('b', '2', 1, 2), makeToken('c', '3', 2, 3)];
