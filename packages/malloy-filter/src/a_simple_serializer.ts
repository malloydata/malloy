...
import { Clause, NumberCondition, NumberClause, StringCondition, BooleanClause, DateClause } from './clause_types'

function aSimpleSerializer() {
    const strings: StringCondition[] = [
