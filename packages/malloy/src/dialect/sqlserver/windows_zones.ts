...
// The IANA name of each time zone, as Malloy spells one, and the Windows name
// AT TIME ZONE takes for it. From CLDR 48 windowsZones.json, plus every
// bcp47 alias of a listed name (Asia/Kolkata beside Asia/Calcutta, Europe/Kyiv
