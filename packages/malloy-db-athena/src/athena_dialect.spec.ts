...
/*
 * The dialect's own behaviour on a live engine v3 workgroup: a nest leaves
 * Athena as JSON and comes back as rows, in every shape core reads one. Runs
 * when ATHENA_WORKGROUP is set; the malloytest tables are not needed.
 */
