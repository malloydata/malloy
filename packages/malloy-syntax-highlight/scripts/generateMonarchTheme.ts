...
export function convertThemeToMonaco(rawTextmateTheme: IRawTheme, monacoTheme: Monaco.IStandaloneThemeData)  {
...
export function writeTheme(theme: Monaco.IStandaloneThemeData, outPath: string) {
