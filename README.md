...
Malloy is an new experimental language for describing data relationships and transformations. Malloy eliminates the distinction between schema and query, tables and results, allowing you to keep your focus on the data and the insights you are trying to gain or the shape of data you are trying to produce.
