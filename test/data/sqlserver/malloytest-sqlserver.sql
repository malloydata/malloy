...
CREATE TABLE malloytest.aircraft_models (
    aircraft_model_code NVARCHAR(100) PRIMARY KEY,
...
CREATE TABLE malloytest.char_aircraft_models (
    aircraft_model_code NVARCHAR(MAX) PRIMARY KEY,
    manufacturer NVARCHAR(MAX),
    model NVARCHAR(MAX),
    aircraft_type_id NVARCHAR(MAX),
    aircraft_engine_type_id NVARCHAR(MAX),
    aircraft_category_id NVARCHAR(MAX),
    amateur NVARCHAR(MAX),
...
CREATE TABLE malloytest.char_aircraft (
    id NVARCHAR(MAX),
    tail_num NVARCHAR(MAX),
    aircraft_serial NVARCHAR(MAX),
    aircraft_model_code NVARCHAR(MAX),
    aircraft_engine_code NVARCHAR(MAX),
    year_built NVARCHAR(MAX),
    aircraft_type_id NVARCHAR(MAX),
    aircraft_engine_type_id NVARCHAR(MAX),
    registrant_type_id NVARCHAR(MAX),
    name NVARCHAR(MAX),
    address1 NVARCHAR(MAX),
    address2 NVARCHAR(MAX),
    city NVARCHAR(MAX),
...
CREATE TABLE malloytest.char_airports (
    id NVARCHAR(MAX),
    code NVARCHAR(MAX),
    site_number NVARCHAR(MAX),
    fac_type NVARCHAR(MAX),
...
CREATE TABLE malloytest.char_alltypes (
    this_string NVARCHAR(MAX),
    this_int NVARCHAR(MAX),
    this_float NVARCHAR(MAX)
);
GO
...
CREATE TABLE malloytest.char_carriers (
    code NVARCHAR(MAX),
    name NVARCHAR(MAX),
    nickname NVARCHAR(MAX)
);
...
CREATE TABLE malloytest.char_flights (
    carrier NVARCHAR(MAX),
    origin NVARCHAR(MAX),
    destination NVARCHAR(MAX),
    flight_num NVARCHAR(MAX),
    flight_time NVARCHAR(MAX),
    tail_num NVARCHAR(MAX),
    dep_time NVARCHAR(MAX),
    arr_time NVARCHAR(MAX),
    dep_delay NVARCHAR(MAX),
    arr_delay NVARCHAR(MAX),
    taxi_out NVARCHAR(MAX),
    taxi_in NVARCHAR(MAX),
...
CREATE TABLE malloytest.char_order_items (
    id NVARCHAR(MAX),
    order_id NVARCHAR(MAX),
    amount NVARCHAR(MAX),
    sku_num NVARCHAR(MAX)
);
GO
...
CREATE TABLE malloytest.char_orders (
    id NVARCHAR(MAX),
    status NVARCHAR(MAX),
...
CREATE TABLE malloytest.char_state_facts (
    state NVARCHAR(MAX),
    aircraft_count NVARCHAR(MAX),
    airport_count NVARCHAR(MAX),
    births NVARCHAR(MAX),
    popular_name NVARCHAR(MAX)
);
GO
...
CREATE TABLE malloytest.char_users (
    id INT IDENTITY(1,1) PRIMARY KEY,
    name NVARCHAR(MAX),
    age NVARCHAR(MAX),
    created_at NVARCHAR(MAX),
    epoch_at NVARCHAR(MAX),
    yyyymmdd_at NVARCHAR(MAX)
);
GO
