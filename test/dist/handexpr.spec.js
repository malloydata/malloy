...
exports.modelAircraftHandStructDef = exports.modelB = exports.joinModelAircraftHandStructDef = exports.exprHandModelDef = exports.aircraftHandStructDef = exports.aircraftHandBase = exports.modelHandBase = void 0;
const test_utils_1 = require("./test_utils");
const runtimes_1 = require("./runtimes");
const runtimes = new runtimes_1.RuntimeList(["bigquery"]);
afterAll(async () => {
...
async function validateCompilation(databaseName, sql) {
    try {
        const runtime = runtimes.runtimeMap.get(databaseName);
        if (runtime === undefined) {
            throw new Error(`Unknown database ${databaseName}`);
        }
        await (await runtime.connections.lookupConnection(databaseName)).runSQL(`WITH test AS(\n${sql}) SELECT 1`);
    }
    catch (e) {
...
function compileHandQueryToSQL(model, queryDef) {
    return model._loadQueryFromQueryDef(queryDef).getSQL();
}
exports.modelHandBase = {
...
exports.aircraftHandStructDef = {
    ...exports.aircraftHandBase,
    fields: [
        ...exports.aircraftHandBase.fields,
        {
            ...exports.modelHandBase,
...
const handCodedModel = {
    name: "Hand Coded Models",
    exports: ["aircraft"],
    contents: {
        aircraft: exports.aircraftHandStructDef,
    },
};
        ...
        pipeline: [
            {
                ...
                fields: [
                    ...
                    // },
                    {
                        ...
                        as: "my_boeing_seats2",
                        filterList: [(0, test_utils_1.fStringEq)("aircraft_models.manufacturer", "BOEING")],
                    },
                ],
            },
        ],
                ...
                fields: [
                    "aircraft_count",
                    {
                        ...
                        pipeline: [
                            ...
                            {
                                type: "reduce",
                                filterList: [(0, test_utils_1.fStringLike)("county", "2%")],
                                fields: [
                                    "state",
                                    {
                                        name: "total_aircraft",
...
/** Flight model */
exports.exprHandModelDef = {
    name: "Hand Coded Expressions",
    exports: ["aircraft"],
    contents: { aircraft: exports.aircraftHandStructDef },
};
exports.joinModelAircraftHandStructDef = {
    ...exports.modelHandBase,
    as: "model_aircraft",
    fields: [
        ...exports.modelHandBase.fields,
        {
            ...exports.aircraftHandBase,
            structRelationship: {
                type: "many",
...
// one to many
exports.modelAircraftHandStructDef = {
    ...exports.modelHandBase,
    as: "model_aircraft",
    fields: [
        ...exports.modelHandBase.fields,
...
const joinModel = {
    ...
    contents: {
        model_aircraft: exports.joinModelAircraftHandStructDef,
    },
};
...
//# sourceMappingURL=handexpr.spec.js.map