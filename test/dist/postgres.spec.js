...
describe("postgres tests", () => {
    it(`raw date tests`, async () => {
        ...
        expect(result.data.path(0, "t_timestamp_w_tz").value).toEqual(new Date("2020-03-02T12:35:56.000Z"));
        expect(result.data.path(0, "t_timestamp_w_tz_second").value).toEqual(new Date("2020-03-02T12:35:56.000Z"));
        expect(result.data.path(0, "t_timestamp_w_tz_minute").value).toEqual(new Date("2020-03-02T12:35:00.000Z"));
        expect(result.data.path(0, "t_timestamp_w_tz_hour").value).toEqual(new Date("2020-03-02T12:00:00.000Z"));
        expect(result.data.path(0, "t_timestamp_w_tz_date").value).toEqual(new Date("2020-03-02"));
        expect(result.data.path(0, "t_timestamp_w_tz_month").value).toEqual(new Date("2020-03-01"));
        expect(result.data.path(0, "t_timestamp_w_tz_year").value).toEqual(new Date("2020-01-01"));
