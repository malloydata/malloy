...
describe("expression tests", () => {
    ...
    it("filtered_measures", async () => {
        const sql = await compileQueryFromQueryDef(faa, {
            ...
            filterList: [
                ...
                (0, test_utils_1.fStringEq)("destination.state", "NY"),
            ],
            pipeline: [{ type: "reduce", fields: ["carriers.name", "flight_count"] }],
        });
        await bqCompile(sql);
                    ...
                    fields: [
                        "aircraft.aircraft_models.manufacturer",
                        {
                            ...
                            e: [
                                {
                                    type: "filterExpression",
                                    filterList: [(0, test_utils_1.fStringEq)("origin_code", "SFO")],
                                    e: [
                                        {
                                            type: "aggregate",
                                            function: "sum",
            ...
            pipeline: [
                {
                    ...
                    filterList: [(0, test_utils_1.fStringEq)("carriers.code", "WN")],
                },
            ],
        });
        await bqCompile(sql);
    ...
    it("add_filter_to_named_query", async () => {
        const sql = await compileQueryFromQueryDef(faa, {
            structRef: "flights",
            filterList: [(0, test_utils_1.fStringEq)("destination_code", "AL")],
