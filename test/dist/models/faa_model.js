            ...
            pipeline: [
                {
                    ...
                    fields: [
                        ...
                        {
                            name: "flight_count",
                            filterList: [(0, test_utils_1.fYearEq)("dep_time", 2001)],
                            as: "flights_2001",
                        },
                        {
                            name: "flight_count",
                            filterList: [(0, test_utils_1.fYearEq)("dep_time", 2002)],
                            as: "flights_2002",
                        },
                    ],
                    orderBy: [{ field: "name", dir: "asc" }],
            ...
            pipeline: [
                {
                    ...
                    filterList: [(0, test_utils_1.fStringEq)("origin.state", "CA")],
                    limit: 5,
                },
            ],
        },
            ...
            pipeline: [
                {
                    ...
                    filterList: [(0, test_utils_1.fStringEq)("destination.state", "NY")],
                    orderBy: [{ field: "flight_count", dir: "desc" }],
                },
            ],
        },
            ...
            pipeline: [
                {
                    type: "reduce",
                    filterList: [
                        (0, test_utils_1.fStringEq)("origin.state", "CA"),
                        (0, test_utils_1.fStringEq)("carrier", "UA"),
                    ],
                    limit: 20,
                    fields: [
                        {
        ...
        */
        {
            ...
            pipeline: [
                {
                    type: "reduce",
                    filterList: [(0, test_utils_1.fStringEq)("carrier", "UA")],
                    limit: 2,
                    fields: [
                        {
                            type: "timestamp",
