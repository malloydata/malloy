window.SEARCH_SEGMENTS = [
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      {
        "type": "p",
        "text": "Hit \"Save,\" then dive into writing Malloy! We recommend starting with one of our Samples, which can be found <a href=\"https://github.com/looker-open-source/malloy/tree/main/samples\">here</a> or downloaded from the VS Code Plugin"
      },
      {
        "type": "p",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      {
        "type": "p",
        "text": "<em>The follow examples all run against the model at the bottom of this page OR you can find the source code <a href=\"https://github.com/looker-open-source/malloy/blob/docs-release/samples/faa/flights.malloy\">here</a>.</em>"
      },
      {
        "type": "code",
  ...
  },
  {
    ...
    "paragraphs": [
      {
        "type": "p",
        "text": "<em>You can find the complete source code for this model <a href=\"https://github.com/looker-open-source/malloy/blob/docs-release/samples/ga_sessions/ga_sessions.malloy\">here</a>.</em>"
      },
      {
        "type": "code",
  ...
  },
  {
    ...
    "paragraphs": [
      {
        "type": "p",
        "text": "The table below shows all columns in the data set and their most common or ranges of values. The Malloy query below (or a derivation of it) can be used to examine just about any dataset."
      }
    ],
    "path": "/examples/iowa/iowa.md"
  },
  {
    ...
    "paragraphs": [
      ...
      {
        "type": "p",
        "text": "<em>The <a href=\"source.html\">Malloy data model</a> can be reviewed in examples under <a href=\"https://github.com/looker-open-source/malloy/blob/docs-release/samples/iowa/iowa.malloy\">'iowa'</a>.</em>"
      },
      {
        "type": "code",
        "text": "<pre class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">query</span><span style=\"color: #000000\">: </span><span style=\"color: #795E26\">table</span><span style=\"color: #000000\">(</span><span style=\"color: #A31515\">&#39;bigquery-public-data.iowa_liquor_sales.sales&#39;</span><span style=\"color: #000000\">) -&gt; { </span><span style=\"color: #AF00DB\">index</span><span style=\"color: #000000\">: * } -&gt; {</span></span>\n<span class=\"line\"><span style=\"color: #000000\">  </span><span style=\"color: #AF00DB\">nest</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">string_columns</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">is</span><span style=\"color: #000000\"> {</span></span>\n<span class=\"line\"><span style=\"color: #000000\">    </span><span style=\"color: #AF00DB\">order_by</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">cardinality</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">asc</span></span>\n<span class=\"line\"><span style=\"color: #000000\">    </span><span style=\"color: #AF00DB\">where</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">fieldType</span><span style=\"color: #000000\"> = </span><span style=\"color: #A31515\">&#39;string&#39;</span></span>\n<span class=\"line\"><span style=\"color: #000000\">    </span><span style=\"color: #AF00DB\">group_by</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">column_name</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">is</span><span style=\"color: #000000\"> </span><span style=\"color: #001080\">fieldName</span></span>\n<span class=\"line\"><span style=\"color: #000000\">    </span><span style=\"color: #AF00DB\">aggregate</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">cardinality</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">is</span><span style=\"color: #000000\"> </span><span style=\"color: #795E26\">count</span><span style=\"color: #000000\">(</span><span style=\"color: #795E26\">distinct</span><span style=\"color: #000000\"> </span><span style=\"color: #001080\">fieldValue</span><span style=\"color: #000000\">)</span></span>\n<span class=\"line\"><span style=\"color: #000000\">    </span><span style=\"color: #AF00DB\">nest</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">values_list_detail</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">is</span><span style=\"color: #000000\"> {</span></span>\n<span class=\"line\"><span style=\"color: #000000\">      </span><span style=\"color: #AF00DB\">top</span><span style=\"color: #000000\">: </span><span style=\"color: #098658\">20</span></span>\n<span class=\"line\"><span style=\"color: #000000\">      </span><span style=\"color: #AF00DB\">group_by</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">fieldValue</span></span>\n<span class=\"line\"><span style=\"color: #000000\">      </span><span style=\"color: #AF00DB\">aggregate</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">rows_matched</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">is</span><span style=\"color: #000000\"> </span><span style=\"color: #001080\">weight</span><span style=\"color: #000000\">.</span><span style=\"color: #795E26\">sum</span><span style=\"color: #000000\">()</span></span>\n<span class=\"line\"><span style=\"color: #000000\">    }</span></span>\n<span class=\"line\"><span style=\"color: #000000\">  }</span></span>\n<span class=\"line\"><span style=\"color: #000000\">  </span><span style=\"color: #AF00DB\">nest</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">other_columns</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">is</span><span style=\"color: #000000\"> {</span></span>\n<span class=\"line\"><span style=\"color: #000000\">    </span><span style=\"color: #AF00DB\">where</span><span style=\"color: #000000\">: </span><span style=\"color: #001080\">fieldType</span><span style=\"color: #000000\"> != </span><span style=\"color: #A31515\">&#39;string&#39;</span></span>\n<span class=\"line\"><span style=\"color: #000000\">    </span><span style=\"color: #AF00DB\">group_by</span><span style=\"color: #000000\">:</span></span>\n<span class=\"line\"><span style=\"color: #000000\">      </span><span style=\"color: #001080\">column_name</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">is</span><span style=\"color: #000000\"> </span><span style=\"color: #001080\">fieldName</span></span>\n<span class=\"line\"><span style=\"color: #000000\">      </span><span style=\"color: #001080\">ranges_of_values</span><span style=\"color: #000000\"> </span><span style=\"color: #AF00DB\">is</span><span style=\"color: #000000\"> </span><span style=\"color: #001080\">fieldValue</span></span>\n<span class=\"line\"><span style=\"color: #000000\">  }</span></span>\n<span class=\"line\"><span style=\"color: #000000\">}</span></span></pre>"
      },
      {
        "type": "code",
        "text": "<pre class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">query</span><span style=\"color: #000000\">: </span><span style=\"color: #795E26\">table</span><span style=\"color: #000000\">(</span><span style=\"color: #A31515\">&#39;bigquery-public-data.iowa_liquor_sales.sales&#39;</span><span style=\"color: #000000\">) -&gt; {</span></span>\n<span class=\"line\"><span style=\"color: #000000\">  </span><span style=\"color: #AF00DB\">project</span><span style=\"color: #000000\">: *</span></span>\n<span class=\"line\"><span style=\"color: #000000\">  </span><span style=\"color: #AF00DB\">top</span><span style=\"color: #000000\">: </span><span style=\"color: #098658\">100</span></span>\n<span class=\"line\"><span style=\"color: #000000\">}</span></span></pre>"
      }
    ],
    "path": "/examples/iowa/iowa.md"
  },
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      {
        "type": "p",
        "text": "<em>You can find the complete source code for this model <a href=\"https://github.com/looker-open-source/malloy/blob/docs-release/samples/names/names.malloy\">here</a>.</em>"
      },
      {
        "type": "code",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      {
        "type": "p",
        "text": "Wordlebot is written in <a href=\"https://github.com/looker-open-source/malloy/\">Malloy</a>. Read about <a href=\"wordle.html\">How Wordlebot is constructed</a> (only 50 lines of code) and a good example of using data to solve interesting problems."
      },
      {
        "type": "p",
        "text": "<a href=\"wordle5.html\">↩️ All Solved Puzzles</a>   |  <a href=\"wordle215.html\">➡️ Next Puzzle</a>"
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      {
        "type": "p",
        "text": "<em>Wordlebot is writen in <a href=\"https://github.com/looker-open-source/malloy/\">Malloy</a>. Read about <a href=\"wordle.html\">How Wordlebot is constructed</a> (only 50 lines of code) and a good example of using data to solve interesting problems.</em>"
      },
      {
        "type": "p",
  ...
  },
  {
    ...
    "paragraphs": [
      {
        "type": "p",
        "text": "Learn the language with zero install using our entirely browser-based <a href=\"https://looker-open-source.github.io/malloy/fiddle/index.html?q=12+-+Line+Chart+with+two+dimension%3A+Flights+by+Month+and+Length&m=Flights&t=\">Malloy Fiddle</a>."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Explore data with the <a href=\"https://github.com/looker-open-source/malloy/tree/main/demo/malloy-demo-composer\">Malloy Composer</a>, a demo of a data exploration application built on top of Malloy"
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "File feature requests/bugs, join discussions, or contribute to Malloy on our <a href=\"https://github.com/looker-open-source/malloy\">Repo</a>."
      }
    ],
    "path": "/index.md"
  },
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      {
        "type": "p",
        "text": "The <a href=\"https://looker-open-source.github.io/malloy/documentation/language/expressions.html#time-expressions\">Time Expressions</a> reference contains substantially more detail and examples."
      },
      {
        "type": "p",
        "text": "Feature requests are tracked using <a href=\"https://github.com/looker-open-source/malloy/issues\">Issues on Github</a>."
      },
      {
        "type": "p",
        "text": "One can also define a <a href=\"https://looker-open-source.github.io/malloy/documentation/language/sql_blocks.html\">SQL block</a> to be used as a source in Malloy."
      }
    ],
    "path": "/language/sql_to_malloy.md"
  },
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      {
        "type": "p",
        "text": "<a href=\"https://github.com/looker-open-source/malloy/\">Install Instructions</a>"
      },
      {
        "type": "p",
