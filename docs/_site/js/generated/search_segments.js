window.SEARCH_SEGMENTS = [
  ...
  },
  {
    ...
    "paragraphs": [
      "The statement to run a query in Malloy is <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">query</span><span style=\"color: #000000\">:</span></span></code>. There are two types of queries in Malloy, grouping queries which have <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">group_by</span><span style=\"color: #000000\">:</span></span></code> or <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">aggregate</span><span style=\"color: #000000\">:</span></span></code> statements, and projecting queries which have <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">project</span><span style=\"color: #000000\">:</span></span></code> statements.",
      "<code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">measure</span><span style=\"color: #000000\">:</span></span></code> is a declared aggregate calculation (think function that operates across the table).  <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #001080\">measures</span><span style=\"color: #000000\">:</span></span></code>  can be used in the <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">aggregate</span><span style=\"color: #000000\">:</span></span></code> element in a query",
      "<code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">dimension</span><span style=\"color: #000000\">:</span></span></code> is declared a scalar calculation that can be be used in a <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">group_by</span><span style=\"color: #000000\">:</span></span></code> or <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">project</span><span style=\"color: #000000\">:</span></span></code> element of a query",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Queries can be run against <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">source</span><span style=\"color: #000000\">:</span></span></code> objects and can utilize the built in calculations. (<a href=\"language/query.html\">Query Documentation</a>)",
      ...
      "<em>simple source declartion used in example below</em>",
      "<em>simple source declartion used in example below</em>",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "To join a foreign key in the source to the <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">primary_key</span></span></code> of a joined source, reference the foreign key by name in the <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #AF00DB\">with</span></span></code> clause.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "The basic syntax for a query in Malloy consists of a source\nand a \"pipeline\" of one or more <em>stages</em> separated by <code class=\"language-malloy\" style=\"background-color: #FBFBFB\"><span class=\"line\"><span style=\"color: #000000\">-&gt;</span></span></code>. The shape of the data defined in the original source is transformed by each stage.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "A Malloy model file can contain several <em>sources</em>, which define fields that can be used in queries.",
