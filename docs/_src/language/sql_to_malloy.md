...
| <pre><code>FROM (...) AS user_facts</code></pre> | <pre> `sql: user_facts is \|\| ... ;; on "connection"` </pre> | **Subqueries** Can be written into [SQL Blocks](https://looker-open-source.github.io/malloy/documentation/language/sql_blocks.html). Example below |
